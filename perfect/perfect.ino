...
///////////////////////////////////
//        传递解码后参数         //
void transferT(int yearT, int monthT, int dayT, int weekT, int hourT, int minuteT, int P0T, int P1T, int P2T, int P3T, int P4T) {
  year_R = yearT;
  month_R = monthT;
  day_R = dayT;
  week_R = weekT;
  ...
  for (k = 0; k < 5; k++)
  {
    for (t = 0; t < 60; t++)
    {
      ...
      if (changed == 0)
      {
        ...
        {
          decoding(bpcarray);
          del = second_R - second_;
          transferT(year_, month_, day_, week_, hour_, minute_, P0, P1, P2, P3, P4);
